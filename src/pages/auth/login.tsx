function LoginPage() {
  return (
    <div className="portal-card mx-auto flex w-full max-w-xl flex-col p-6 sm:p-8 lg:p-10">
      <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[var(--color-primary)]">Sign in</p>
      ...
      <div className="mt-6 space-y-3">
        ...
        <button className="w-full rounded-full bg-[var(--color-primary)] px-4 py-3 font-semibold text-slate-950 transition hover:bg-[var(--color-primary-strong)]">Log in</button>
      </div>
      <p className="mt-4 text-sm text-slate-400">
        New here? <a href="/signup" className="text-[var(--color-primary)]">Create an account</a>
      </p>
    </div>
  )
}
